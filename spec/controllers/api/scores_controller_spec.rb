...
describe Api::ScoresController, type: :request do
  ...
  describe 'GET feed' do
    ...
    it 'should return the scores size of 25' do
      26.times do
        total_score = Random.rand(66..99)
        played_at = Time.zone.now - Random.rand(1..10).days
        create(:score, user: @user1, total_score: total_score, played_at: played_at)
      end
